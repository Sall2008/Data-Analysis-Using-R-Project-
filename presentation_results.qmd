...
-   $\text{dist}_{i}^{\text{primary}}$ measures distance to the nearest primary school (km) \vspace{0.1em}
-   $\text{dist}_{i}^{\text{secondary}}$ measures distance to the nearest secondary school (km) \vspace{0.1em}
