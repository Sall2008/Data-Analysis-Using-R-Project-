...
### ==== 2.0.2 Regression Sample Social Index ====
...
### ==== 2.3.1 Model comparison Distance ====
fit_main <- tibble(
...
#### ==== 2.5.3  Table 3: Baseline continuous vs baseline binned ====
...
#### ==== 2.5.4  Table 4: Model comparison ====
...
#### ==== 2.5.5  Table 5: Robustness checks ====
...
#### ==== 2.5.6  Table 6: Social Index Regression (5km) ====
...
### ==== 2.6.2 Continuous Distance vs Log Price per sqm ====
...
### ==== 2.6.3  Social Index Visualisations ====

### ==== 2.6.4 Spatial Distribution Social Index Schools in NRW ====
