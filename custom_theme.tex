  ...
  \ifnum\insertframenumber>1
    ...
    \begin{beamercolorbox}[wd=\paperwidth,ht=0.4ex,dp=0ex]{progress bar}
      \rule{\dimexpr\paperwidth*
        ...
        /\numexpr\contenttotalframes-1\relax}{0.4ex}
    \end{beamercolorbox}
...
% --------------------------------------------------
% Frame limit macro (for progress bar)
% --------------------------------------------------
\newcounter{contentframe}
\setcounter{contentframe}{0}

\newcommand{\setcontentend}{
  \setcounter{contentframe}{\value{framenumber}}
}

\newcommand{\contenttotalframes}{
  \ifnum\value{contentframe}>0
    \value{contentframe}
  \else
...
\setbeamertemplate{frametitle}{%
  \nointerlineskip
  \par
  \vspace*{2.5ex} % distance from top → title
